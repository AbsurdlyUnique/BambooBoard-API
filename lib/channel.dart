...
import 'package:bambooboard/utility/html_template.dart';
...
class BambooboardChannel extends ApplicationChannel
  ...
  Future prepare() async {
    ...
    final config = BambooboardConfiguration(options!.configurationFilePath!);
...
class BambooboardConfiguration extends Configuration {
  BambooboardConfiguration(String fileName) : super.fromFile(File(fileName));
